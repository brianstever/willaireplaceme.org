...
const SECTOR_DESCRIPTIONS: Record<string, string> = {
  ...
  manufacturing:
    "Durable and nondurable goods production, factories, and assembly plants",
  healthcare: "Health care and social assistance establishments",
  retail:
    "Stores, e-commerce, motor vehicle dealers, and food/beverage retailers",
  professional:
    "Professional, scientific, technical, management, administrative, and support services",
  information:
    "Software, data processing, telecommunications, publishing, and broadcasting",
  government:
    "Federal, state, and local government positions excluding military",
  ...
  unemployment_manufacturing:
    "Manufacturing wage and salary workers; not seasonally adjusted",
  // Participation rate
  ...
  return (
    <div className="space-y-1">
      <div
        ...
        aria-label={
          isUnemploymentMode
            ? "Filter unemployment by industry"
            : isParticipationMode
              ? "Filter participation by industry"
      ...
      >
        {sortedSectors.map((sector) => {
          ...
          const buttonStyle: CSSProperties | undefined = isSelected
            ? {
