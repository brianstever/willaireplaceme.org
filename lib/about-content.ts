...
export const CHART_FEATURES: ViewFeature[] = [
  {
    ...
    description:
      "Filter data by time period: 1Y, 3Y, 5Y, 10Y, or ALL. The selected range is shared across views.",
    borderColor: "border-white/20",
  },
  {
    title: "TRENDLINE TOGGLE",
    description:
      "Enable a linear regression trendline to visualize the overall direction of the data. The change indicator compares the first and last observations in the selected period, using percent for openings and percentage points for rates.",
    borderColor: "border-white/20",
  },
  {
    title: "CHATGPT RELEASE DATE",
    description:
      "A vertical reference line marks November 2022—when ChatGPT launched. The marker is historical context; it does not establish a causal relationship with changes in openings. Toggle this marker on/off via the chart controls.",
